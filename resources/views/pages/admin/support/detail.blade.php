                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.support')}}">Yêu cầu hỗ trợ</a>
                        </li>
...
<section class="section support-request-details mb-5">
    <div class="container-fluid">
        <div class="card p-4">
            <div class="row">
                <div class="col-md-8">
                    <h5 class="mb-3">{{ $support->support_code }} {{ $support->title }}</h5>
                </div>

                <div class="col-md-4 text-end d-flex align-items-center justify-content-end gap-3">
                    <div class="d-flex align-items-center">
                        <span class="text-muted me-2">{{Carbon\Carbon::parse($support->created_at)->setTimezone('Asia/Ho_Chi_Minh')->format('d/m/Y')}}</span>
                        <span class="text-muted">{{Carbon\Carbon::parse($support->created_at)->setTimezone('Asia/Ho_Chi_Minh')->format('H:i')}}</span>
                    </div>
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <form action="{{route('admin.support.store', $support->id)}}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="mb-3">
                            <label for="reply-content" class="form-label">Nội dung</label>
                            <textarea name="content" id="reply-content" class="form-control" rows="4" placeholder="Nhập nội dung"></textarea>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="file" class="form-control d-none" name="files[]" id="inputFile">
