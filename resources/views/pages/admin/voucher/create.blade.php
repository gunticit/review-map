                ...
                <div class="col-inner">
                    ...
                    <form action="{{ route('voucher.store') }}" id="form-create-voucher" method="POST"
                        ...
                        <div class="mb-4">
                            ...
                            <!-- Select dropdown for selecting how to enter the discount code -->
                            ...
                            <!-- Input field for entering or displaying the discount code -->
                            <input class="form-control mt-3" id="codeInput" name="code" type="text" placeholder="Nhập mã giảm giá" value="{{ old('code') }}" required>
                            @error('code')
