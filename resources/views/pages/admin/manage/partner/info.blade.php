                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <input class="form-control" id="company_name" type="text" placeholder="Tên công ty" value="" disabled="">
                            </div>
                            <div class="mb-4">
                                <label for="tax">Mã số thuế </label>
                                <input class="form-control " id="tax" type="number" placeholder="Mã số thuế" value="" disabled="">
                            </div>
                            <div class="mb-4">
                                <label for="company_email">Email <span class="required">*</span>
                                </label>
                                <input class="form-control mb-1" id="company_email" type="email" name="email" placeholder="Email" value="" disabled="">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="form-check">
                                        <input type="checkbox" disabled="" class="form-check-input" id="is_receive">
                            ...
                            <div class="mb-4">
                                ...
                                <input class="form-control" id="company_address" type="text" placeholder="Địa chỉ công ty" value="" disabled="">
                            </div>
                        </div>
                    </div>
                </div>
